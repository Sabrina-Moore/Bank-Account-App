#Rework of a CS1 Coding Project

In my first semester of C++, we had to make a bank account app with user verification and some commands. In CS2 Data Structures, we learned how to link and separate files to subdivide tasks, and also about the class data structure.
I thought I would retry this app with the new parameters:
